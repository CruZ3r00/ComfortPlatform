...
test('0008-0009 su staging: ComforTables in tables di ct_app, public a cs_site; funzioni, trigger, realtime, permessi', async (t) => {
  ...
  assert.deepEqual((await apply({ client: admin, dir: MIGRATIONS_DIR })).applied, ['0008_comfortables_tables_schema.sql', '0009_site_public_schema.sql', '0010_comfortables_bus_subscriptions.sql', '0011_comfortables_logistics_subscriptions.sql', '0012_bus_replay.sql', '0013_comfortables_account_subscriptions.sql'])
...
test('0008-0009 rieseguite convergono; rollback riporta tutto com\'era e le migrazioni si riapplicano', async (t) => {
  ...
  await admin.query(`delete from platform.migrations
    where name in ('0010_comfortables_bus_subscriptions.sql', '0011_comfortables_logistics_subscriptions.sql', '0012_bus_replay.sql',
