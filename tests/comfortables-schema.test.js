...
test('0008-0009 su staging: ComforTables in tables di ct_app, public a cs_site; funzioni, trigger, realtime, permessi', async (t) => {
  ...
  assert.deepEqual((await apply({ client: admin, dir: MIGRATIONS_DIR })).applied, ['0008_comfortables_tables_schema.sql', '0009_site_public_schema.sql', '0010_comfortables_bus_subscriptions.sql', '0011_comfortables_logistics_subscriptions.sql', '0012_bus_replay.sql'])
